namespace Aurora.Framework
{
    internal static class ExceptionMessages
    {
        ...
        internal const string InvalidOptionsAttributeSetting = "Options catalog type attribute not set.";
        internal const string InvalidOptionsItemAttributeValue = "Item count cannot be greater than '{0}' items.";
