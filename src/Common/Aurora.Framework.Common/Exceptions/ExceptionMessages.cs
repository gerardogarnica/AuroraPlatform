namespace Aurora.Framework
{
    internal static class ExceptionMessages
    {
        ...
        internal const string InvalidOptionsCatalogAttributeSetting = "Options catalog type attribute not set.";
        internal const string InvalidOptionsCatalogItemAttributeValue = "Item count cannot be greater than '{0}' items.";
